<div class="sidebar">
  <ul class="sidebar-menu">
    ...
    <li class="sidebar-menu-item">
      <a href="ControllerServlet?action=supplier" class="sidebar-menu-link">
        <i class="fas fa-truck"></i>Suppliers</a>
    </li>
    <li class="sidebar-menu-item">
      <a href="ControllerServlet?action=purchase" class="sidebar-menu-link">
        <i class="fas fa-shopping-cart"></i>Purchases</a>
    </li>
    <li class="sidebar-menu-item">
      <a href="ControllerServlet?action=customer" class="sidebar-menu-link">
    ...
    <li class="sidebar-menu-item">
      <a href="ControllerServlet?action=about" class="sidebar-menu-link">
